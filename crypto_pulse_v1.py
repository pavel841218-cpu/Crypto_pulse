...
def analyze_ignition(base, candles):
    ...
    # объём уже аномальный, хотя свеча не закрылась
...
def analyze_flow(base, candles):
    ...
    # После дампа >=5% шортить поздно — блокируем только SHORT
...
async def process_symbol(base):
    ...
    if ignition and signal_allowed(base):
        ...
        return  # не дублируем сигнал FLOW в этом цикле
...
async def refresh_universe():
    ...
    # Инвалидация кэша свечей для монет, выпавших из вселенной
...
async def scan_cycle():
    ...
    # Семафор 3 + пауза 0.15 — защита от 429 при 350 монетах
