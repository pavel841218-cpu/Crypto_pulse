...
# ============================================================
#       CEX FUTURES AGGREGATOR v3.2 (FIXED)
...
# ------------------------------------------------------------
BITGET_MIN_RVOL = 2.5          # Bitget: свеча минимум в 2.5x от среднего
...
# ------------------------------------------------------------
BINANCE_MIN_RVOL = 2.0         # Binance: свеча минимум в 2.0x
...
async def start_background(app):
    ...
    startup_msg = (
        "🚀 <b>CEX FUTURES AGGREGATOR v3.2 ЗАПУЩЕН</b>\n\n"
        "• <b>Bitget = сканер</b> (лидер)\n"
        "• <b>Binance = подтверждение</b>\n"
        f"• Binance API: {bn_status}\n"
        f"• Ценовой фильтр: {MIN_PRICE_USDT}–{MAX_PRICE_USDT} USDT\n\n"
        "📊 Логика:\n"
        "1. Bitget ищет импульс (RVOL + движение)\n"
        "2. Binance подтверждает (RVOL + OI + спред [-0.2%..+3.0%])\n"
    ...
    log.info("CEX FUTURES AGGREGATOR v3.2 STARTED")
